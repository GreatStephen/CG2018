...
function buildScene() {
    ...
    let tree = loadMesh("resources/model/Furniture/Chair.obj","resources/model/Furniture/Chair.mtl","chair");
    tree.translateX(-10);
    tree.translateZ(30);
    [tree.scale.x, tree.scale.y, tree.scale.z] = [2, 2, 2];
    scene.add(tree);
    collision_items.push(tree);
